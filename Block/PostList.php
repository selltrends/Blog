<?php
namespace Atopt\Blog\Block;

use Atopt\Blog\Api\Data\PostInterface;
use Atopt\Blog\Model\ResourceModel\Post\Collection as PostCollection;
    ...
    \Magento\Framework\DataObject\IdentityInterface
{
     ...
     * @param \Atopt\Blog\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory,
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Atopt\Blog\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory,
        array $data = []
    ) {
